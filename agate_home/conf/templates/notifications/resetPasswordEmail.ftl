    ...
    <div
      ...
      <div
        ...
        <h3
          ...
          <span>CanPath</span> - Password Reset<span style="float: right !important;font-size: 13px;vertical-align: text-bottom;">French version below</span></h3>
      </div>
      <div class="panel-body" style="padding: 15px;">
        ...
        <p style="margin: 0 0 10px;">
          You or an administrator has requested a password reset of your account.
        </p>
        <p style="margin: 0 0 10px;">
        </p>
  ...
  <div style="margin: auto;max-width: 700px;">
    <div
      ...
      <div
        ...
        <h3
                style="font-family: 'Lato','Helvetica Neue',Helvetica,Arial,sans-serif;font-weight: 400;line-height: 1.1;color: inherit;margin-top: 0;margin-bottom: 0;font-size: 17px;">
          <span>CanPath</span> - Réinitialisation du mot de passe<span style="float: right !important;font-size: 13px;vertical-align: text-bottom;">Version anglaise ci-dessus</span></h3>
      </div>
      <div class="panel-body" style="padding: 15px;">
        <p style="margin: 0 0 10px;">
        ...
        <p style="margin: 0 0 10px;">
          Vous ou un administrateur a demandé une réinitialisation du mot de passe de votre compte.
        </p>
        <p style="margin: 0 0 10px;">
        </p>
        <p style="margin: auto;text-align: center;">
