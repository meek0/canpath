    ...
    <div
      ...
      <div
        ...
        <h3
          ...
          <span>CanPath</span> - Access Request Under Review</h3>
      </div>
      <div class="panel-body" style="padding: 15px;">
        ...
        <p style="margin: 0 0 10px;">
          The status of the access request "<strong>${title}</strong>" has been changed from <strong>Submitted</strong> to <strong>Under review</strong>.
  ...
  <div style="margin: auto;max-width: 700px;">
    <div
      ...
      <div
        ...
        <h3
                style="font-family: 'Lato','Helvetica Neue',Helvetica,Arial,sans-serif;font-weight: 400;line-height: 1.1;color: inherit;margin-top: 0;margin-bottom: 0;font-size: 17px;">
          <span>CanPath</span> - Demande d’accès en cours d’examen<span style="float: right !important;font-size: 13px;vertical-align: text-bottom;">Version anglaise ci-dessus</span></h3>
      </div>
      <div class="panel-body" style="padding: 15px;">
        <p style="margin: 0 0 10px;">
        ...
        <p style="margin: 0 0 10px;">
          Le statut de votre demande d’accès "<strong>${title}</strong>" a été changé de <strong>Soumise</strong> à <strong>Examen en cours</strong>. Vous pouvez cliquer <a href="${publicUrl}/data-access/${id}" target="_blank">ici</a> pour afficher et gérer votre demande d'accès.
        </p>
