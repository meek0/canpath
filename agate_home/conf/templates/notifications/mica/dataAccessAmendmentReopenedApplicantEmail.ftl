    ...
    <div
      ...
      <div
        ...
        <h3
          ...
          <span>CanPath</span> - Amendment Request Incomplete<span style="float: right !important;font-size: 13px;vertical-align: text-bottom;">French version below</span></h3>
      </div>
      <div class="panel-body" style="padding: 15px;">
        ...
        <p style="margin: 0 0 10px;">
          Your amendment request "<strong>${title}</strong> (<strong>${id}</strong>)" has been deemed incomplete and re-opened in order for you to provide the necessary clarifications.
          Please refer to the detailed information provided by the Access Office.
          You can click <a href="${publicUrl}/data-access-amendment-form/${id}" target="_blank">here</a> to view the status of your request.
        </p>
  ...
  <div style="margin: auto;max-width: 700px;">
    <div
      ...
      <div
        ...
        <h3
                style="font-family: 'Lato','Helvetica Neue',Helvetica,Arial,sans-serif;font-weight: 400;line-height: 1.1;color: inherit;margin-top: 0;margin-bottom: 0;font-size: 17px;">
          <span>CanPath</span> - Demande de modification incomplète<span style="float: right !important;font-size: 13px;vertical-align: text-bottom;">Version anglaise ci-dessus</span></h3>
      </div>
      <div class="panel-body" style="padding: 15px;">
        <p style="margin: 0 0 10px;">
        ...
        <p style="margin: 0 0 10px;">
          Votre demande de modification "<strong>${title}</strong> (<strong>${id}</strong>)" a été jugée incomplète et a été réouverte afin que vous puissiez fournir les informations nécessaires.
          Veuillez-vous référer aux renseignements détaillés fournis par le Bureau d'accès. Vous pouvez cliquer <a href="${publicUrl}/data-access-amendment-form/${id}" target="_blank">ici</a> pour afficher et gérer votre demande.
        </p>
        <div style="margin: 30px 0 0;">
