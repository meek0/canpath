    ...
    <div
      ...
      <div
        ...
        <h3
          ...
          <span>CanPath</span> - Feasibility Request Review Complete<span style="float: right !important;font-size: 13px;vertical-align: text-bottom;">French version below</span></h3>
      </div>
      <div class="panel-body" style="padding: 15px;">
        ...
        <p style="margin: 0 0 10px;">
          Your feasibility request "<strong>${title}</strong> (<strong>${id}</strong>)" has been approved. Please refer to the detailed information provided by the Access Office. A copy of the Access Agreement will be sent to you in due course. You can click <a href="${publicUrl}/data-access-feasibility-form/${id}" target="_blank">here</a> to view the status of your request.
        </p>
  ...
  <div style="margin: auto;max-width: 700px;">
    <div
      ...
      <div
        ...
        <h3
                style="font-family: 'Lato','Helvetica Neue',Helvetica,Arial,sans-serif;font-weight: 400;line-height: 1.1;color: inherit;margin-top: 0;margin-bottom: 0;font-size: 17px;">
          <span>CanPath</span> - Examen de la demande de faisabilité terminé<span style="float: right !important;font-size: 13px;vertical-align: text-bottom;">Version anglaise ci-dessus</span></h3>
      </div>
      <div class="panel-body" style="padding: 15px;">
        <p style="margin: 0 0 10px;">
        ...
        <p style="margin: 0 0 10px;">
          Votre demande de faisabilité "<strong>${title}</strong> (<strong>${id}</strong>)" a été approuvée. Veuillez-vous référer aux renseignements détaillés fournis par le Bureau d'accès. Vous pouvez cliquer <a href="${publicUrl}/data-access-feasibility-form/${id}" target="_blank">ici</a> pour voir le statut de votre demande.
        </p>
        <div style="margin: 30px 0 0;">
          <hr width="55%" size="1" align="left" style="padding: 0; margin-top: 0;"/>
          <p style="font-family:monospace;font-size: 10px">
