  ...
  <div style="margin: auto;max-width: 700px;">
    <div
      ...
      <div class="panel-body" style="padding: 15px;">
        ...
        <p style="margin: 0 0 10px;">
          Your access request"<strong>${title}</strong> (<strong>${id}</strong>)" has been conditionally approved and re-opened in order for you to provide the necessary clarifications.
          Please refer to the detailed information provided by the Access Office. You can click <a href="${publicUrl}/data-access/${id}" target="_blank">here</a> to view the status of your access request.
        </p>
