    ...
    <div
      ...
      <div
        ...
        <h3
          ...
          <span>CanPath</span> - Amendment Request Submission Confirmation<span style="float: right !important;font-size: 13px;vertical-align: text-bottom;">French version below</span></h3>
      </div>
      <div class="panel-body" style="padding: 15px;">
        ...
        <p style="margin: 0 0 10px;">
          Thank you for submitting your amendment request "<strong>${title}</strong> (<strong>${id}</strong>)" to the Canadian Partnership for Tomorrow's Health (CanPath). We encourage you to regularly visit this <a href="${publicUrl}/data-access-amendment-form/${id}" target="_blank">link</a> to view the status of your request.
        </p>
  ...
  <div style="margin: auto;max-width: 700px;">
    <div
      ...
      <div
        ...
        <h3
                style="font-family: 'Lato','Helvetica Neue',Helvetica,Arial,sans-serif;font-weight: 400;line-height: 1.1;color: inherit;margin-top: 0;margin-bottom: 0;font-size: 17px;">
          <span>CanPath</span> - Confirmation de la soumission de la demande de modification<span style="float: right !important;font-size: 13px;vertical-align: text-bottom;">Version anglaise ci-dessus</span></h3>
      </div>
      <div class="panel-body" style="padding: 15px;">
        <p style="margin: 0 0 10px;">
        ...
        <p style="margin: 0 0 10px;">
          Merci d'avoir soumis votre demande de modification "<strong>${title}</strong> (<strong>${id}</strong>)" au Partenariat canadien pour la santé de demain (CanPath). Nous vous encourageons à visiter régulièrement ce <a href="${publicUrl}/data-access-amendment-form/${id}" target="_blank">lien</a> pour voir le statut de votre demande.
        </p>
        <div style="margin: 30px 0 0;">
