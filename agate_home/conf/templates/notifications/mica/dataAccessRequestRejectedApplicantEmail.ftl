  ...
  <div style="margin: auto;max-width: 700px;">
    <div
      ...
      <div class="panel-body" style="padding: 15px;">
        ...
        <p style="margin: 0 0 10px;">
          Your access request"<strong>${title}</strong> (<strong>${id}</strong>)" has been rejected. Please refer to the detailed information provided by the Access Office. You can click <a href="${publicUrl}/data-access/${id}" target="_blank">here</a> to view the status of your access request.
        </p>
  ...
  <div style="margin: auto;max-width: 700px;">
    <div
      ...
      <div class="panel-body" style="padding: 15px;">
        ...
        <p style="margin: 0 0 10px;">
          Votre demande d'accès "<strong>${title}</strong> (<strong>${id}</strong>)" a été rejetée. Veuillez-vous référer aux renseignements détaillés fournis par le Bureau d'accès. Vous pouvez cliquer <a href="${publicUrl}/data-access/${id}" target="_blank">ici</a> pour voir le statut de votre demande d'accès.
        </p>
        <div style="margin: 30px 0 0;">
