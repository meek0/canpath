    ...
    <div
      ...
      <div
        ...
        <h3
          ...
          <span>CanPath</span> - Amendment Request<span style="float: right !important;font-size: 13px;vertical-align: text-bottom;">French version below</span></h3>
      </div>
      <div class="panel-body" style="padding: 15px;">
        ...
        <p style="margin: 0 0 10px;">
          A comment has been added to the access request "<strong>${title}</strong> (<strong>${parentId}</strong>)". Please click <a href="${publicUrl}/data-access-amendment-form/${id}" target="_blank">here</a> to view the comment.
        </p>
  ...
  <div style="margin: auto;max-width: 700px;">
    <div
      ...
      <div
        ...
        <h3
                style="font-family: 'Lato','Helvetica Neue',Helvetica,Arial,sans-serif;font-weight: 400;line-height: 1.1;color: inherit;margin-top: 0;margin-bottom: 0;font-size: 17px;">
          <span>CanPath</span> - Demande de modification<span style="float: right !important;font-size: 13px;vertical-align: text-bottom;">Version anglaise ci-dessus</span></h3>
      </div>
      <div class="panel-body" style="padding: 15px;">
        <p style="margin: 0 0 10px;">
        ...
        <p style="margin: 0 0 10px;">
          Un commentaire a été ajouté à la demande d'accès "<strong>${title}</strong> (<strong>${parentId}</strong>)". Veuillez cliquer <a href="${publicUrl}/data-access-amendment-form/${id}" target="_blank">ici</a> pour voir le commentaire.
        </p>
        <div style="margin: 30px 0 0;">
          <hr width="55%" size="1" align="left" style="padding: 0; margin-top: 0;"/>
          <p style="font-family:monospace;font-size: 10px">
