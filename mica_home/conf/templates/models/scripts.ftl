...
<script>
  ...
  const MlstrTranslations = {
    ...
    "cohort_study": "<@message "Cohort"/>",
    "case_control": "<@message "Case-control"/>",
    "case_only": "<@message "Case only"/>",
    "cross_sectional": "<@message "Cross-sectional"/>",
    "clinical_trial": "<@message "Clinical trial"/>",
    "other": "<@message "Other"/>",
