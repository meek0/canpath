...
<#macro projectModelSummary project>
  <#if project.model??>
    <span class="badge badge-info moment-date2">${project.model.startDate}</span>
    <small><i class="fas fa-arrow-right"></i></small>
    <span class="badge badge-info moment-date2">${project.model.endDate}</span> -
    <small>
        ...
        <div class="card">
          ...
          <div class="card-body">
            <dl class="row">
              ...
              <dd class="col-sm-8 moment-date2">${project.model.startDate}</dd>
              <dt class="col-sm-4"><@message "end-date"/></dt>
              <dd class="col-sm-8 moment-date2">${project.model.endDate}</dd>
            </dl>
          </div>
        </div>
      </div>
